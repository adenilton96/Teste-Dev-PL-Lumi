...
router.get("/", async (req, res) => {
 ...
 router.get("/dados/:numero_cliente/:mes_referencia", async (req, res) => {
    try {
 ...
 router.get("/dados/:numero_cliente", async (req, res) => {
    try {
 ...
 router.post("/extraiDadosPdfUnico", async (req, res) => {
     try {
 ...
 router.post("/extraiDadosPdfLote", async (req, res) => {
     try {
